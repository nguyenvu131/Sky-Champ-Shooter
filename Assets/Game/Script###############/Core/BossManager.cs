...
public class BossManager : MonoBehaviour
{
    ...
    void SpawnBoss(BossWave bossWave)
    {
        ...
        // Gắn sự kiện chết cho boss (nếu boss có Health)
        MonsterHealthBoss enemyHealth = currentBoss.GetComponent<MonsterHealthBoss>();
        if (enemyHealth != null)
        {
            enemyHealth.OnDeath += OnBossDead;
        }
